...
class Speech:
    ...
    # TODO: CAMBIAR EL NOMBRE DE LA CARPETA DE AUDIOS TODO LO QUE DIGA FINANTY-V2
    def add_silence(self):
        ...
        os.makedirs(f'./FINANTY-V2/audios/{self.iteration}', exist_ok=True)
        self.audio_silent.export(f'./FINANTY-V2/audios/{self.iteration}/{self.id_audio}.wav', format='wav')
