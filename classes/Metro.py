...
class Speech:
    ...
    # TODO: CAMBIAR EL NOMBRE DE LA CARPETA DE AUDIOS TODO LO QUE DIGA METRO-V2
    def add_silence(self):
        ...
        os.makedirs(f'./METRO-V2/audios/{self.iteration}', exist_ok=True)
        self.audio_silent.export(f'./METRO-V2/audios/{self.iteration}/{self.id_audio}.wav', format='wav')
